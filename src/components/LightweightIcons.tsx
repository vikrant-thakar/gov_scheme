// Lightweight icon component to replace heavy icon libraries
...
const icons: Record<string, string> = {
  ...
  'notification': 'M15 17h5l-5 5v-5zM10 17h5l-5 5v-5zM5 17h5l-5 5v-5z',
...
export default function LightweightIcon({ name, className = '', size = 24 }: IconProps) {
