    ...
    <div className="max-w-3xl mx-auto py-16 px-4 text-gray-100">
      ...
      <section className="mb-8">
        <p className="text-lg mb-4">
          Welcome to <span className="font-semibold">Adhikaar</span>. By accessing or using this platform, you agree to comply with and be bound by the following terms and conditions. Please read them carefully.
        </p>
      </section>
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2 text-green-300">1. Acceptance of Terms</h2>
        <p>
          By using Adhikaar, you acknowledge that you have read, understood, and agree to be bound by these Terms &amp; Conditions and all applicable laws and regulations.
        </p>
      </section>
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 text-gray-200">
          <li className="mb-2">Adhikaar is intended for informational purposes to help users discover and understand government schemes.</li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          All content, design, graphics, and other materials on Adhikaar are the intellectual property of Adhikaar or its licensors. You may not reproduce, distribute, or create derivative works without explicit permission.
        </p>
      </section>
      <section className="mb-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Adhikaar strives to provide accurate and up-to-date information, but does not guarantee the completeness, accuracy, or reliability of any content. Adhikaar is not liable for any loss or damage arising from your use of the platform.
        </p>
      </section>
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2 text-green-300">6. Changes to Terms</h2>
        <p className="mb-4">
          Adhikaar reserves the right to modify these Terms &amp; Conditions at any time. Changes will be posted on this page. Continued use of the platform after changes constitutes acceptance of those changes.
        </p>
      </section>
      <section className="mb-8">
