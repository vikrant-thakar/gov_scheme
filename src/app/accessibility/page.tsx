    ...
    <div className="max-w-3xl mx-auto py-16 px-4 text-gray-100">
      ...
      <section className="mb-8">
        <p className="text-lg mb-4">
          <span className="font-semibold">Zycoon</span> is committed to ensuring that our platform is accessible to all users, regardless of device, technology, or ability. Our goal is to provide maximum accessibility and usability for every visitor.
        </p>
        <p className="text-lg mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          We are continuously working to improve the accessibility of Zycoon. If you encounter any issues or have suggestions, please contact us at:
        </p>
